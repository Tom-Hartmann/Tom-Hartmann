  ...
  run: async (client, interaction, args) => {
    if (interaction.options.getSubcommand() === "admin") {
      ...
      return interaction.reply({
        content:
          "This message will be edited, each time you change a setting!\n",
      ...
      const welcomerMenu = new ActionRowBuilder().addComponents(
        new StringSelectMenuBuilder()
      ...
      const loggingMenu = new ActionRowBuilder().addComponents(
        new StringSelectMenuBuilder()
