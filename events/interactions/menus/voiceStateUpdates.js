...
module.exports = async(interaction, client) => {
    ...
    if (interaction.values[0] === "voice_state_updates") {
        ...
        if (!data) {
            await msg.edit("Please send the **CHANNEL ID** to open Private channels")
            ...
            collector.on('collect', async(collected, returnValue) => {
                ...
                return msg.edit(`Private voice channels will be created once joined in ${interaction.guild.channels.cache.get(channelID)}`)
            })
