  ...
  if (interaction.customId === "help_menu") {
    ...
    if (interaction.values[0] === "settings") {
      ...
      const musicEmbed = new Discord.EmbedBuilder()
        ...
        .setDescription(
          "`clearqueue`, `filter`, `filter list`, `info`, `jump`, `loop`, `lyrics`, `move`, `mute`, `pause`, `play`, `previoustrack`, `queue`, `remove`, `resume`, `unmute`, `volume`, `youtube`\n\n```Note: Music commands work only with slash commands!```"
        )
        .setColor("BLUE");
      ...
      const gameEmbed = new Discord.EmbedBuilder()
        ...
        .setDescription("`catchthefish`, `football`, `gunfight`")
        .setColor("Random");
